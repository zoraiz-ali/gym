...
class Environment(tk.Toplevel, object):
    def __init__(self):
        super(Environment, self).__init__()
        self.action_space = ['up', 'down', 'left', 'right']
        self.n_actions = len(self.action_space)
        self.title('Deep Q-learning. Zoraiz Ali')
    ...
    def build_environment(self):
        ...
        img_obstacle1 = Image.open(r"C:\\Users\ZORAIZ\gym\gym_robot\envs\\images\\road_closed1.png")
        self.obstacle1_object = ImageTk.PhotoImage(img_obstacle1)
        # Obstacle type 2 - tree1
        img_obstacle2 = Image.open(r"C:\\Users\\ZORAIZ\\gym\\gym_robot\\envs\\images\\tree1.png")
        self.obstacle2_object = ImageTk.PhotoImage(img_obstacle2)
        # Obstacle type 3 - tree2
        img_obstacle3 = Image.open(r"C:\\Users\ZORAIZ\gym\gym_robot\envs\\images\\tree2.png")
        self.obstacle3_object = ImageTk.PhotoImage(img_obstacle3)
        # Obstacle type 4 - building1
        img_obstacle4 = Image.open(r"C:\\Users\\ZORAIZ\\gym\\gym_robot\\envs\\images\\building1.png")
        self.obstacle4_object = ImageTk.PhotoImage(img_obstacle4)
        # Obstacle type 5 - building2
        img_obstacle5 = Image.open(r"C:\\Users\\ZORAIZ\\gym\\gym_robot\\envs\\images\\building2.png")
        self.obstacle5_object = ImageTk.PhotoImage(img_obstacle5)
        # Obstacle type 6 - road closed2
        img_obstacle6 = Image.open(r"C:\\Users\ZORAIZ\\gym\\gym_robot\\envs\\images\\road_closed2.png")
        self.obstacle6_object = ImageTk.PhotoImage(img_obstacle6)
        # Obstacle type 7 - road closed3
        img_obstacle7 = Image.open(r"C:\\Users\ZORAIZ\\gym\\gym_robot\\envs\\images\\road_closed3.png")
        self.obstacle7_object = ImageTk.PhotoImage(img_obstacle7)
        # Obstacle type 8 - traffic lights
        img_obstacle8 = Image.open(r"C:\\Users\\ZORAIZ\\gym\\gym_robot\\envs\\images\\traffic_lights.png")
        self.obstacle8_object = ImageTk.PhotoImage(img_obstacle8)
        # Obstacle type 9 - pedestrian
        img_obstacle9 = Image.open(r"C:\\Users\\ZORAIZ\\gym\\gym_robot\\envs\\images\\pedestrian.png")
        self.obstacle9_object = ImageTk.PhotoImage(img_obstacle9)
        # Obstacle type 10 - shop
        img_obstacle10 = Image.open(r"C:\\Users\\ZORAIZ\\gym\\gym_robot\\envs\\images\\shop.png")
        self.obstacle10_object = ImageTk.PhotoImage(img_obstacle10)
        # Obstacle type 11 - bank1
        img_obstacle11 = Image.open(r"C:\\Users\\ZORAIZ\\gym\\gym_robot\\envs\\images\\bank1.png")
        self.obstacle11_object = ImageTk.PhotoImage(img_obstacle11)
        # Obstacle type 12 - bank2
        img_obstacle12 = Image.open(r"C:\\Users\\ZORAIZ\\gym\\gym_robot\\envs\\images\\bank2.png")
        ...
        # Final Point
        img_flag = Image.open(r"C:\\Users\ZORAIZ\\gym\\gym_robot\\envs\\images\\flag.png")
        ...
        img_robot = Image.open(r"C:\\Users\\ZORAIZ\\gym\\gym_robot\\envs\\images\\agent1.png")
